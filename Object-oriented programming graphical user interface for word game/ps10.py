...
class Hand(object):
    ...
    def containsLetters(self, letters):
        ...
        for letter in letters:
            if self.handDict.get(letter,0) == 0:
                return False
            if letters.count(letter) > self.handDict[letter]:
                return False
            return True       
    ...
    def isEmpty(self):
        ...
        """
        for letter_key in self.handDict.keys():
            if self.handDict[letter_key] > 0:
                return False
    ...
    def __eq__(self, other):
        ...
        """
        for letter_key in self.handDict.keys():
            if self.handDict[letter_key] != other.handDict.get(letter_key, 0):
                return False
        return True
    ...
    def pickBestWord(self, wordlist):
        ...
        for word in wordlist.getList():
            if self.hand.containsLetters(word):
                new_word_score = getWordScore(word)
